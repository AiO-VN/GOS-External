...
-- RETURN IF LOADED
if (_G.GamsteronJhinLoaded) then
    return;
end
_G.GamsteronJhinLoaded = true;
...
-- MENU
local Menu = MenuElement({name = "Gamsteron Jhin", id = "gsojhin", type = MENU, leftIcon = "https://raw.githubusercontent.com/gamsteron/GOS-External/master/Icons/gsojhin23d.png"})
